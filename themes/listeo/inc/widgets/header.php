...
/**
 * Custom widgets for listeo theme
 *
 *
 * @package listeo
 * @since listeo 1.0
...
add_action('widgets_init', 'listeo_load_header_widget'); // Loads widgets here
function listeo_load_header_widget() {
    register_widget('Listeo_Header');
}


class Listeo_Header extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'listeo_header_widget', // Base ID
            __( 'Listeo Header Widget', 'listeo' ), // Name
            array( 'description' => __( 'Use in Header Section', 'listeo' ) ) // Args
        );
    }
        ...
        <ul class="header-widget">
            ...
            <li>
                ...
                <div class="widget-content"> 
                    <span class="title"><?php echo esc_html($first_box_title ); ?></span>
                    <span class="data"><?php echo esc_html($first_box_subtitle ); ?></span>
                </div>
            </li>
            <?php } 
            ...
            <li>
                ...
                <div class="widget-content">
                    <span class="title"><?php echo esc_html($second_box_title ); ?></span>
                    <span class="data"><?php echo esc_html($second_box_subtitle ); ?></span>
                </div>
            </li>
            <?php } 

            if ( ! empty( $button_submit )) {   ?>
                <li class="with-btn"><a href="<?php echo get_permalink( realteo_get_option( 'submit_property_page' ) ); ?>" class="button border medium"><?php esc_html_e('Submit Property', 'listeo'); ?></a></li>
            <?php   }  ?>
        </ul>
...
/*        $instance['first_box_title']    = sanitize_text_field( $new_instance['first_box_title'] );
        ...
        */
        $instance = array();
        $instance['first_box_title']  = ( ! empty( $new_instance['first_box_title'] ) ) ? strip_tags( $new_instance['first_box_title'] ) : '';
        $instance['first_box_subtitle'] = ( ! empty( $new_instance['first_box_subtitle'] ) ) ? strip_tags( $new_instance['first_box_subtitle'] ) : '';
        $instance['first_box_icon']   = ( ! empty( $new_instance['first_box_icon'] ) ) ? strip_tags( $new_instance['first_box_icon'] ) : '';

        $instance['second_box_title']  = ( ! empty( $new_instance['second_box_title'] ) ) ? strip_tags( $new_instance['second_box_title'] ) : '';
        $instance['second_box_subtitle'] = ( ! empty( $new_instance['second_box_subtitle'] ) ) ? strip_tags( $new_instance['second_box_subtitle'] ) : '';
        $instance['second_box_icon']   = ( ! empty( $new_instance['second_box_icon'] ) ) ? strip_tags( $new_instance['second_box_icon'] ) : '';
    ...
    public function form( $instance ) {
        ...
        $second_box_title = sanitize_text_field( $instance['second_box_title'] );
        $second_box_subtitle = sanitize_text_field( $instance['second_box_subtitle'] );
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('first_box_title')); ?>"><?php esc_html_e('First box title:', 'listeo' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('first_box_subtitle')); ?>"><?php esc_html_e('First box subtitle:', 'listeo' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('first_box_icon')); ?>"><?php esc_html_e('First box icon:', 'listeo' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('second_box_title')); ?>"><?php esc_html_e('Second box title:', 'listeo' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('second_box_subtitle')); ?>"><?php esc_html_e('Second box subtitle:', 'listeo' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('second_box_icon')); ?>"><?php esc_html_e('Second box icon:', 'listeo' ); ?></label>
        ...
        <hr />
         ...
         <p>
            <label for="<?php echo esc_attr($this->get_field_id('button_submit')); ?>"><?php esc_html_e('Submit property button:', 'listeo' ); ?></label>
            ...
            <span class="description"><?php _e( 'Enable this option to show a button "Submit Property"','listeo'); ?></span>
        </p>  

...
(function ( $ ) {
	...
	$(function () {
	    ...
	    var clusterStyles = [
		  {
		    textColor: 'white',
		    url: listeo.theme_url+'/images/m1.png',
		    height: 50,
		    width: 50
		  },
		 {
		    textColor: 'white',
		    url: listeo.theme_url+'/images/m2.png',
		    height: 50,
		    width: 50
		  },
		 {
		    textColor: 'white',
		    url: listeo.theme_url+'/images/m3.png',
		    height: 50,
		    width: 50
		  },
		 {
		    textColor: 'white',
		    url: listeo.theme_url+'/images/m4.png',
		    height: 50,
		    width: 50
		  },
		  {
		    textColor: 'white',
		    url: listeo.theme_url+'/images/m5.png',
		    height: 50,
		    width: 50
		  }
		];
      	...
      	function initialize() {
	        map = new google.maps.Map(document.getElementById('listeo-map'), {
	           	zoom: zoomLevel,

...
class TaxonomyCarousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Taxonomy Carousel', 'elementor-listeo' );
	}
...
// 	'taxonomy' => '',
   ...
   //          'autoplayspeed'      => '3000',
					...
					<div class="category-box-container">
						<a href="<?php echo esc_url(get_term_link( $term )); ?>" class="category-box" data-background-image="<?php echo $cover[0];  ?>">
							<div class="category-box-content">
								...
								<?php if($settings['show_counter'] == 'yes'): ?><span><?php echo $term->count ?> <?php esc_html_e('listings','listeo-elementor'); ?></span><?php endif; ?>
							</div>
							<span class="category-box-btn"><?php esc_html_e('Browse','listeo-elementor') ?></span>
						</a>
					</div>
				</div>
	...
	protected function get_terms($taxonomy) {
		$taxonomies = get_terms( array( 'taxonomy' =>$taxonomy) );

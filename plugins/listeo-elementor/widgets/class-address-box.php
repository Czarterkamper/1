...
class Addresbox extends Widget_Base {
	...
	public function get_title() {
		return __( 'Address box', 'elementor-listeo' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'content',
			[
				'label' => __( 'Address', 'elementor-listeo' ),
				'type' => \Elementor\Controls_Manager::WYSIWYG,
				'rows' => 5,
				'placeholder' => __( 'Enter your Address & details', 'elementor-listeo' ),
			]
		);
		...
		$this->add_control(
			'latitude',
			array(
				'label'   => __( 'Map Marker Latitude', 'elementor-listeo' ),
		...
		$this->add_control(
			'longitude',
			array(
				'label'   => __( 'Map Marker Longitude', 'elementor-listeo' ),
				'type'    => Controls_Manager::TEXT,
			)
		);	
		$this->add_control(
	...
	protected function render() {
		...
		<div class="contact-map margin-bottom-55">
			...
			<div id="singleListingMap-container">
				...
				<a href="#" id="streetView"><?php echo esc_html__('Street View','elementor-listeo') ?></a>
			</div>

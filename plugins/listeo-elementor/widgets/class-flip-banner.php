  ...
  //           'from_vs' 		=>	'no'
	protected function _register_controls() {
		...
		$this->add_control(
			'text_visible',
			array(
				'label'   => __( 'Front text', 'elementor-listeo' ),
		...
		$this->add_control(
			'text_hidden',
			array(
				'label'   => __( 'Flipped text', 'elementor-listeo' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Text after hover', 'elementor-listeo' ),
			)
		);
		...
		$this->add_control(
			'color',
			[
				'label' => __( 'Overlay Color', 'elementor-listeo' ),
		...
		$this->add_control(
			'opacity',
			[
				'label' => __( 'Overlay Opacity', 'elementor-listeo' ),
		...
		// 		'rows' => 5,
		// 		'placeholder' => __( 'Enter your notification text', 'elementor-listeo' ),
		// 	]
		// );
		...
		// 	'type',
		// 	[
		// 		'label' => __( 'Notice type tag ', 'elementor-listeo' ),
		// 		'type' => \Elementor\Controls_Manager::SELECT,
		// 		'default' => 'success',
		// 		'options' => [
		// 			'success' 	=> __( 'Success', 'elementor-listeo' ),
		// 			'error' 	=> __( 'Error', 'elementor-listeo' ),
		// 			'warning' 	=> __( 'Warning', 'elementor-listeo' ),
		// 			'notice' 	=> __( 'Notice', 'elementor-listeo' ),

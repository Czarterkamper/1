...
class PricingTable extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Table', 'elementor-listeo' );
	}
 ...
 //        "buttontext"    => 'Sign Up',
		...
		$this->add_control(
			'price',
			array(
				'label'   => __( 'Price', 'elementor-listeo' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( '19.99', 'elementor-listeo' ),
			)
		);	
		$this->add_control(
			'discounted',
			array(
				'label'   => __( 'Discount', 'elementor-listeo' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( '8.99', 'elementor-listeo' ),
			)
		);	
		$this->add_control(
			'per',
			array(
				'label'   => __( 'Per', 'elementor-listeo' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'month', 'elementor-listeo' ),
			)
		);
		...
		$this->add_control(
			'buttonlink',
			[
				'label' => __( 'Buy button URL','elementor-listeo' ),

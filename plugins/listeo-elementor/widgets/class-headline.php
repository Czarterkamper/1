...
class Headline extends Widget_Base {
	...
	public function get_title() {
		return __( 'Headline', 'elementor-listeo' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'subtitle',
			array(
				'label'   => __( 'Subtitle', 'elementor-listeo' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
			)
		);
		...
		$this->add_control(
			'type',
			[
				'label' => __( 'Element tag ', 'elementor-listeo' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'h3',
				'options' => [
					'h1' => __( 'H1', 'elementor-listeo' ),
					'h2' => __( 'H2', 'elementor-listeo' ),
					'h3' => __( 'H3', 'elementor-listeo' ),
					'h4' => __( 'H4', 'elementor-listeo' ),
					'h5' => __( 'H5', 'elementor-listeo' ),
				],
			]
		);
		...
		$this->add_control(
		  'text_align',
		  [
		    'label' => __( 'Text align', 'elementor-listeo' ),
		    'type' => \Elementor\Controls_Manager::CHOOSE,
		    'options' => [
		      'left' => [
		        'title' => __( 'Left', 'elementor-listeo' ),
		        'icon' => 'fa fa-align-left',
		      ],
		      'center' => [
		        'title' => __( 'Center', 'elementor-listeo' ),
		        'icon' => 'fa fa-align-center',
		      ],
		      'right' => [
		        'title' => __( 'Right', 'elementor-listeo' ),
		...
		$this->add_control(
			'with_border',
			[
				'label' => __( 'With Border', 'elementor-listeo' ),
